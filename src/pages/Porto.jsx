...
import { formattedHo, formattedTokobunga } from "../utils/Loadimg";
      ...
      <div className="flex justify-center mt-8">
        <div className="flex flex-col md:flex-row bg-white dark:bg-gray-800 rounded-lg shadow-md max-w-4xl overflow-hidden">
          ...
          <div className="p-6 flex flex-col justify-center md:w-1/2">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            Projek akademik dimana kami dikelompokan sebagai tim yang ditugaskan membangun sebuah Sistem Basis Data. Dalam perancangan sistem basis data terdapat beberapa tahapan yang dibagikan dengan masing masing anggota. Pada tugas kelompok ini mendapatkan tahapan perancangan UI/UX dari Toko Bunga itu sendiri.
            </p>
            <a
              href="https://www.figma.com/proto/hrjijnIJpFQMB2ygiy4mL7/Tugas-SBD?page-id=0%3A1&node-id=65-33&p=f&viewport=-2170%2C-786%2C0.31&t=zTlEoAArmYpvbnjN-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=65%3A33"
              target="_blank"
              rel="noopener noreferrer"
